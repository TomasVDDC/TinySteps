...
export default function NotificationsScreen() {
  ...
  return (
    <View>
      ...
      <Button onPress = {SendNotification}> <Text> Send Notification</Text></Button>
    </View>
  )
}
...
// // Cancel all scheduled notifications that haven't appeared yet
// Notifications.cancelAllScheduledNotificationsAsync();


// // // Dismiss all notifications that are currently shown
